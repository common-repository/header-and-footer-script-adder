=== Header and Footer Scripts Adder ===

Contributors: mahethekiller,Mr Narendra Kumar Singh
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ESSBBUCDBPAG2
Tags: header scripts, footer scripts, footer, scripts, post, admin,header
...
Header and Footer Scripts Adder allows you to add scripts to header and footer of your theme.
...
With the help of my senior Mr. Narendra Kumar Singh , Senior Software Developer Roi Mantra , I developed this plugin . Thanks For your Support

= Benefits of the plugin: =
* You will be able to insert Google Analytics or other Web-analytics code, meta-informations, CSS and JS codes to `<head>`
...
Upload the plugin to `/wp-content/plugins` and activate. OR Search "Header and Footer Scripts Adder" from `WP Dashbard --> Plugins --> Add New` then hit Install

== Screenshots ==
1. Access this page from `Dashboard --> Settings --> Header and Footer Scripts Adder`
...
* Added few functionalities and bug fixes